    ...
    >
      ...
      >
        <button
          type="button"
          onClick={onClose}
          className="absolute right-3 top-3 z-10 rounded-full bg-black/25 p-1.5 text-white transition hover:bg-black/45"
          aria-label="Cerrar"
        >
          <X className="h-5 w-5" />
        </button>

        <div className="relative h-28 bg-gradient-to-r from-brand to-brand-dark">
        ...
        <div className="px-6 pb-6 pt-14 text-center">
          ...
          <div className="mt-3 inline-flex items-center gap-2 rounded-full bg-live px-3.5 py-1.5 text-xs font-bold uppercase tracking-wide text-white">
